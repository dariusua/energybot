...
def sending_g3():
    ...
    results = cursor.fetchall()
    howmuchtime1 = datetime.now() + timedelta(minutes=9)
    howmuchtime2 = howmuchtime1 + timedelta(hours=4)
    for result in results:
...
schedule.every().monday.at("12:30").do(sending_g1)
schedule.every().tuesday.at("08:30").do(sending_g1)
schedule.every().tuesday.at("20:30").do(sending_g1)
schedule.every().wednesday.at("16:30").do(sending_g1)
schedule.every().thursday.at("12:30").do(sending_g1)
schedule.every().friday.at("08:30").do(sending_g1)
schedule.every().friday.at("20:30").do(sending_g1)
schedule.every().saturday.at("16:30").do(sending_g1)
schedule.every().sunday.at("12:30").do(sending_g1)

#Розсилка для 2 групи
schedule.every().monday.at("08:30").do(sending_g2)
schedule.every().monday.at("20:30").do(sending_g2)
schedule.every().tuesday.at("16:30").do(sending_g2)
schedule.every().wednesday.at("12:30").do(sending_g2)
schedule.every().thursday.at("08:30").do(sending_g2)
schedule.every().thursday.at("20:30").do(sending_g2)
schedule.every().friday.at("16:30").do(sending_g2)
schedule.every().saturday.at("12:30").do(sending_g2)
schedule.every().sunday.at("08:30").do(sending_g2)
schedule.every().sunday.at("20:30").do(sending_g2)
