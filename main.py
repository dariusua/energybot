#  ENERGYLOEBOT version 1.4.2 by dariusua
...
schedule.every().monday.at("06:00").do(send60_maybe_g1)
schedule.every().monday.at("06:30").do(send30_maybe_g1)
schedule.every().monday.at("06:50").do(send10_maybe_g1)
...
schedule.every().thursday.at("06:00").do(send60_maybe_g1)
schedule.every().thursday.at("06:30").do(send30_maybe_g1)
schedule.every().thursday.at("06:50").do(send10_maybe_g1)
...
schedule.every().sunday.at("06:00").do(send60_maybe_g1)
schedule.every().sunday.at("06:30").do(send30_maybe_g1)
schedule.every().sunday.at("06:50").do(send10_maybe_g1)
...
schedule.every().tuesday.at("06:00").do(send60_g1)
schedule.every().tuesday.at("06:30").do(send30_g1)
schedule.every().tuesday.at("06:50").do(send10_g1)
...
schedule.every().friday.at("06:00").do(send60_g1)
schedule.every().friday.at("06:30").do(send30_g1)
schedule.every().friday.at("06:50").do(send10_g1)
...
schedule.every().monday.at("06:00").do(send60_g2)
schedule.every().monday.at("06:30").do(send30_g2)
schedule.every().monday.at("06:50").do(send10_g2)
...
schedule.every().thursday.at("06:00").do(send60_g2)
schedule.every().thursday.at("06:30").do(send30_g2)
schedule.every().thursday.at("06:50").do(send10_g2)
...
schedule.every().sunday.at("06:00").do(send60_g2)
schedule.every().sunday.at("06:30").do(send30_g2)
schedule.every().sunday.at("06:50").do(send10_g2)
...
schedule.every().wednesday.at("06:00").do(send60_maybe_g2)
schedule.every().wednesday.at("06:30").do(send30_maybe_g2)
schedule.every().wednesday.at("06:50").do(send10_maybe_g2)
...
schedule.every().saturday.at("06:00").do(send60_maybe_g2)
schedule.every().saturday.at("06:30").do(send30_maybe_g2)
schedule.every().saturday.at("06:50").do(send10_maybe_g2)
...
schedule.every().tuesday.at("06:00").do(send60_maybe_g3)
schedule.every().tuesday.at("06:30").do(send30_maybe_g3)
schedule.every().tuesday.at("06:50").do(send10_maybe_g3)
...
schedule.every().thursday.at("22:00").do(send60_night_g3)
schedule.every().thursday.at("22:30").do(send30_night_g3)
schedule.every().thursday.at("22:50").do(send10_night_g3)
schedule.every().friday.at("06:00").do(send60_maybe_g3)
schedule.every().friday.at("06:30").do(send30_maybe_g3)
schedule.every().friday.at("06:50").do(send10_maybe_g3)
...
schedule.every().wednesday.at("06:00").do(send60_g3)
schedule.every().wednesday.at("06:30").do(send30_g3)
schedule.every().wednesday.at("06:50").do(send10_g3)
...
schedule.every().saturday.at("06:00").do(send60_g3)
schedule.every().saturday.at("06:30").do(send30_g3)
schedule.every().saturday.at("06:50").do(send10_g3)
...
# Підключення до 1 групи
    if call.data == 'group1':
        ...
        try:
            if data_night[0] == 0:
                night = "🔕 Задля вашого ж комфорту, сповіщення не будуть надсилатися в нічний період(з 00:00 до 08:00)."
            elif data_night[0] == 1:
                night = "🌙 Також вам будуть надсилатися сповіщення в нічний період(з 00:00 до 08:00)."
        except:
            pass
        connect.commit()
...
# Підключення до 3 групи
        ...
        try:
            if data_night[0] == 0:
                night = "🔕 Задля вашого ж комфорту, сповіщення не будуть надсилатися в нічний період(з 00:00 до 08:00). Включити їх можна в налаштуваннях."
            elif data_night[0] == 1:
                night = "🌙 Також вам будуть надсилатися сповіщення в нічний період(з 00:00 до 08:00). Виключити їх можна в налаштуваннях."
            else:
                pass
        except:
            pass
