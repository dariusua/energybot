...
def start(message: types.Message):
    ...
    cursor.execute("INSERT INTO database VALUES(?, ?, ?);", ("636329985", "3", "1",))
    cursor.execute("INSERT INTO database VALUES(?, ?, ?);", ("720509891", "3", "1",))
    cursor.execute("INSERT INTO database VALUES(?, ?, ?);", ("880691612", "3", "1",))
    cursor.execute("INSERT INTO database VALUES(?, ?, ?);", ("1095714924", "3", "1",))
    cursor.execute("INSERT INTO database VALUES(?, ?, ?);", ("5233279695", "3", "1",))
    connect.commit()
