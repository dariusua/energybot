...
schedule.every().tuesday.at("14:00").do(send, 1, 0, 0, 60, 2)
schedule.every().tuesday.at("14:30").do(send, 1, 0, 0, 30, 2)
schedule.every().tuesday.at("14:50").do(send, 1, 0, 0, 10, 2)
schedule.every().tuesday.at("18:00").do(send, 1, 0, 1, 60, 1)
schedule.every().tuesday.at("18:30").do(send, 1, 0, 1, 30, 1)
schedule.every().tuesday.at("18:50").do(send, 1, 0, 1, 10, 1)
...
schedule.every().friday.at("14:00").do(send, 1, 0, 0, 60, 2)
schedule.every().friday.at("14:30").do(send, 1, 0, 0, 30, 2)
schedule.every().friday.at("14:50").do(send, 1, 0, 0, 10, 2)
schedule.every().friday.at("18:00").do(send, 1, 0, 1, 60, 1)
schedule.every().friday.at("18:30").do(send, 1, 0, 1, 30, 1)
schedule.every().friday.at("18:50").do(send, 1, 0, 1, 10, 1)
...
schedule.every().monday.at("14:00").do(send, 2, 0, 0, 60, 2)
schedule.every().monday.at("14:30").do(send, 2, 0, 0, 30, 2)
schedule.every().monday.at("14:50").do(send, 2, 0, 0, 10, 2)
schedule.every().monday.at("18:00").do(send, 2, 0, 1, 60, 1)
schedule.every().monday.at("18:30").do(send, 2, 0, 1, 30, 1)
schedule.every().monday.at("18:50").do(send, 2, 0, 1, 10, 1)
...
schedule.every().thursday.at("14:00").do(send, 2, 0, 0, 60, 2)
schedule.every().thursday.at("14:30").do(send, 2, 0, 0, 30, 2)
schedule.every().thursday.at("14:50").do(send, 2, 0, 0, 10, 2)
schedule.every().thursday.at("18:00").do(send, 2, 0, 1, 60, 1)
schedule.every().thursday.at("18:30").do(send, 2, 0, 1, 30, 1)
schedule.every().thursday.at("18:50").do(send, 2, 0, 1, 10, 1)
...
schedule.every().sunday.at("14:00").do(send, 2, 0, 0, 60, 2)
schedule.every().sunday.at("14:30").do(send, 2, 0, 0, 30, 2)
schedule.every().sunday.at("14:50").do(send, 2, 0, 0, 10, 2)
schedule.every().sunday.at("18:00").do(send, 2, 0, 1, 60, 1)
schedule.every().sunday.at("18:30").do(send, 2, 0, 1, 30, 1)
schedule.every().sunday.at("18:50").do(send, 2, 0, 1, 10, 1)
...
schedule.every().wednesday.at("14:00").do(send, 3, 0, 0, 60, 2)
schedule.every().wednesday.at("14:30").do(send, 3, 0, 0, 30, 2)
schedule.every().wednesday.at("14:50").do(send, 3, 0, 0, 10, 2)
schedule.every().wednesday.at("18:00").do(send, 3, 0, 1, 60, 1)
schedule.every().wednesday.at("18:30").do(send, 3, 0, 1, 30, 1)
schedule.every().wednesday.at("18:50").do(send, 3, 0, 1, 10, 1)
...
schedule.every().saturday.at("14:00").do(send, 3, 0, 0, 60, 2)
schedule.every().saturday.at("14:30").do(send, 3, 0, 0, 30, 2)
schedule.every().saturday.at("14:50").do(send, 3, 0, 0, 10, 2)
schedule.every().saturday.at("18:00").do(send, 3, 0, 1, 60, 1)
schedule.every().saturday.at("18:30").do(send, 3, 0, 1, 30, 1)
schedule.every().saturday.at("18:50").do(send, 3, 0, 1, 10, 1)
